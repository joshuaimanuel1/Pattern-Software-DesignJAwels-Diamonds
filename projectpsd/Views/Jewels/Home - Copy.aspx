...
<div style="margin-top: 20px;">
    ...
    <asp:GridView ID="gvJewels" runat="server" AutoGenerateColumns="false" CssClass="gvStyle"
        OnRowCommand="GvJewels_RowCommand" DataKeyNames="JewelID"> <%-- PERHATIKAN: OnRowCommand diubah --%>
        <Columns>
        ...
        <HeaderStyle BackColor="#333" ForeColor="White" Font-Bold="True" HorizontalAlign="Left" Padding="8px" />
